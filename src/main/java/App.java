...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Результат сравнения bean HelloWorld: " + HelloWorldBean1.equals(HelloWorldBean2));
        System.out.println("Результат сравнения bean Cat: " + catBean1.equals(catBean2));
    }
}